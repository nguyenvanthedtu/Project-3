<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true" CodeBehind="LienHe.aspx.cs" Inherits="CDIO.LienHe" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link
      rel="stylesheet"
      href="./assets/fonts/fontawesome-free-5.14.0/css/all.min.css "
    />
    ...
    <link href="assets/css/lien-he.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">


    <main style="margin-top:110px ;background-color:#fff ;transform: translateY(2px)" id="main">
        ...
        <div class="page-title">
            ...
            <div class="breadcrumb">
                <ul>
                    ...
                    <li class="current-page">LIÊN HỆ</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="grid wide">
      <div class="row">
        <div class="col l-6 m-12 c-12">
          <div class="contact-section__item contact-section-left">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3834.1050413579414!2d108.20762381438529!3d16.06003804395121!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x314219b4239d8e51%3A0x96e408c6b0419760!2sDuy%20Tan%20University!5e0!3m2!1sen!2s!4v1621072603778!5m2!1sen!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
        </div> 
        </div>

        <div class="col l-6 m-12 c-12">
          <div class="contact-section-right contact-section__item">
            <div class="contact-info">
                <div class="logo">
                    <img style="width:170px ; height:50px" src="http://mauweb.monamedia.net/gwatch/wp-content/uploads/2018/11/logo-mwatch-01.png" class="attachment-original size-original" alt="" srcset="http://mauweb.monamedia.net/gwatch/wp-content/uploads/2018/11/logo-mwatch-01.png 512w, http://mauweb.monamedia.net/gwatch/wp-content/uploads/2018/11/logo-mwatch-01-300x78.png 300w" sizes="(max-width: 512px) 100vw, 512px">
                </div>
            ...
            <div class="lien-he-form">
              <h2 style="opacity:.7;">LIÊN HỆ VỚI CHÚNG TÔI</h2>

              <div style="margin-bottom:20px" class="icon_contact">
                <i class="fas fa-grip-lines"></i>
                <i style="color:var(--main-color)" class="far fa-clock"></i>
                <i class="fas fa-grip-lines"></i>
              </div>
              <div class="lien-he-form-main">
