<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Product-detail.Master" AutoEventWireup="true" CodeBehind="Danhgia.aspx.cs" Inherits="CDIO.Danhgia" %>
    ...
    <div class="product-price">
      ...
      <div class="danhgia">
           ...
           <div  class="content" style="width: 44%;">
            ...
            <div   class="content"  style="width: 44%;">
                  <p>Nội dung</p>
                <textarea id="txtcontent" cols="20" rows="2" CssClass="input-login" style="width: 345px;height: 111px;padding: 10px;font-size: 15px;color: #666;" runat="server"></textarea>
                      
                 </div>
          <div   class="content"  style="width: 44%;">
                  <p>Bạn hãy đánh giá mấy sao cho sản phẩm này?</p>
              <asp:DropDownList ID="sosao" runat="server" style="margin: 20px;font-size: 15px;width: 50px;">
                  ...
                  <asp:ListItem>5</asp:ListItem>
                    ...
                    <i class="fas fa-star" style="color:orange;transform: translate(-10px, 1px);font-size:20px"></i>
                 </div>
    </div>
       <div class="btn-submit" style="margin-bottom:30px;">
                    <asp:Button ID="danhgia" runat="server" Text="GỬI ĐÁNH GIÁ" style="border: 1px solid #2f80ed;border-radius: 4px;color: #2f80ed;display: block;line-height: 17px;margin-left: 3%;padding: 11px 5px;text-align: center;width: 48.5%;margin: 20px 0px;font-size: 15px;cursor:pointer;transform: translateX(70px);" OnClick="btn_danhgia_Click"/>
