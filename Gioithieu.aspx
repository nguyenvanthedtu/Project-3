<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true" CodeBehind="Gioithieu.aspx.cs" Inherits="CDIO.Gioithieu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      ...
      <main style="background-color:#fff" style="transform: translateY(-200px);" id="main">
                ...
                <div class="page-title">
                    ...
                    <div class="breadcrumb">
                        <ul>
                            ...
                            <li class="current-page">GIỚI THIỆU</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <section class="section">
              <h1 style="font-size: 5em;margin: .67em 0;text-align: center;color: #555555;">Smart Watch</h1>
       
                      
                              <div class="">
                                  
                                  <i class="fas fa-grip-lines"style="color:#555555; font-size:24px; font-weight:900"></i>
                                  <i style = "padding: 0 4px; color:var(--main-color);font-size:24px; font-weight:900 "class="far fa-clock"></i>
                                  <i class="fas fa-grip-lines" style="color:#555555; font-size:24px; font-weight:900"></i>
                              </div>
                <p>Mẫu website về đồng hồ/Smart watch là tổng hợp những mẫu website được thiết kế nhằm vào sản phẩm đó là đồng hồ và các loại phụ kiện công nghệ giống như đồng hồ, 
                    đồng hồ thông minh, đồng hồ thể thao, đồng hồ chạy bộ, đồng hồ đo được nhịp tim,… Hãy lướt qua một loạt những mẫu website của chúng tôi để hoàn thành ý tưởng riêng của mình nhé, 
                    dưới đây là những mẫu web được lấy ý tưởng từ những website nổi tiếng trong nước và quốc tế về cả chức năng và giao diện.!</p>
                <div class="description">
                    <div class="left">
                        <div class="box">
                            <div class="box-icon">
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 501.551 501.551" style="enable-background:new 0 0 501.551 501.551;" xml:space="preserve">
                                    ...
                                    <path style="fill:#FF7058;" d="M323.396,347.951c-39.706,39.706-104.49,39.706-144.196,0s-39.706-104.49,0-144.196
                                        ...
                                        c0,33.437,27.167,61.649,61.649,61.649c16.718,0,32.392-7.314,42.841-17.763L323.396,347.951z"></path>                             <g>
                                    </svg>
                            </div>
                            <h2>Các chức năng mới</h2>
                            <%--<p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ratione nisi numquam recusandae
                                modi distinctio voluptas sint nobis soluta aperiam eos!</p>--%>
                            <ul style="font-size: 1.8em;line-height: 25px;color: #777777;width: 250px;">
                               
                                <li>Chức năng tìm kiếm .</li>
                                <li>Tính năng giỏ hàng.</li>
                                ...
                                <li>Chức năng báo cáo sản phẩm khuyến mãi</li>
                                <li>Chức năng xem thông tin tài khoản người dùng</li>
                                
                            </ul>
                        </div>
                        <div class="box" style="margin-top:100%;">
                            <div class="box-icon">
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 502.596 502.596" style="enable-background:new 0 0 502.596 502.596;" xml:space="preserve">
                                    <path style="fill:#F2F2F2;" d="M484.833,349.518H16.718C7.314,349.518,0,356.833,0,366.237v1.045C0,376.686,7.314,384,16.718,384
                                        h469.159c9.404,0,16.718-7.314,16.718-16.718v-1.045C501.551,356.833,494.237,349.518,484.833,349.518z"></path>
                                    <path style="fill:#CDD6E0;" d="M460.8,382.955l-21.943,15.673l-14.629,10.449c-4.18,2.09-8.359,4.18-12.539,4.18H89.861
                                        c-4.18,0-9.404-1.045-12.539-4.18l-14.629-10.449l-21.943-15.673H460.8z"></path>
                                    <polygon style="fill:#B8CAD8;" points="460.8,382.955 438.857,399.673 62.694,399.673 40.751,382.955 "></polygon>
                                    <path style="fill:#40596B;" d="M458.71,41.273H42.841c-11.494,0-20.898,9.404-20.898,20.898v287.347h458.71V62.171
                                        C479.608,50.678,470.204,41.273,458.71,41.273z"></path>
                                    <rect x="48.577" y="67.908" style="fill:#84DBFF;" width="404.375" height="254.955"></rect>
                                    <path style="fill:#B8CAD8;" d="M266.449,362.057h-31.347c-3.135,0-5.224,2.09-5.224,5.224c0,3.135,2.09,5.224,5.224,5.224h31.347
                                        c3.135,0,5.224-2.09,5.224-5.224C270.629,364.147,268.539,362.057,266.449,362.057z"></path>
                                    <path style="fill:#334A5E;" d="M480.653,139.494H310.335c-11.494,0-20.898,9.404-20.898,20.898v280.033
                                        ...
                                        C501.551,148.898,492.147,139.494,480.653,139.494z"></path>
                                    <rect x="306.364" y="178.27" style="fill:#F2F2F2;" width="178.678" height="234.057"></rect>
                                    <g>
                                        <path style="fill:#4CDBC4;" d="M409.6,428.931h-32.392c-4.18,0-7.314,3.135-7.314,7.314c0,4.18,3.135,7.314,7.314,7.314H409.6
                                            c4.18,0,7.314-3.135,7.314-7.314C417.959,432.065,413.78,428.931,409.6,428.931z"></path>
                                        <path style="fill:#4CDBC4;" d="M422.139,156.212h-53.29c-2.09,0-3.135,1.045-3.135,3.135c0,2.09,1.045,3.135,3.135,3.135h53.29
                                            c2.09,0,3.135-1.045,3.135-3.135C425.273,157.257,424.229,156.212,422.139,156.212z"></path>
                                    </g>
                                    <polygon style="fill:#FF7058;" points="317.649,187.559 262.269,187.559 262.269,168.751 216.294,207.412 262.269,247.118 
                                        262.269,228.31 317.649,228.31 "></polygon>
                                    <polygon style="fill:#FFD15C;" points="277.943,281.6 334.367,281.6 334.367,300.408 380.343,261.747 334.367,222.041 
                                        334.367,240.849 277.943,240.849 "></polygon>
                                    </svg>
                            </div>
                            <h2 style="width:290px;">Thiết kế website đáp ứng</h2>
                           <p>
                               Thiết kế web đáp ứng là cách sử dụng HTML và CSS để tự động thay đổi kích thước, ẩn, thu nhỏ hoặc phóng to một
                               trang web để làm cho trang web trông đẹp mắt
                           </p>
                        </div>
                    </div>
                    <div class="center">
                        <img src="./assets/img/img_intro/anywhere_finish_crop.png" alt="">
                    </div>
                    <div class="right">
                        <div class="box">
                            <div class="box-icon">
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 501.551 501.551" style="enable-background:new 0 0 501.551 501.551;" xml:space="preserve">
                                    <polygon style="fill:#CDD6E0;" points="362.58,461.845 140.016,461.845 158.824,429.453 160.914,426.318 169.273,410.645 
                                        170.318,409.6 331.233,409.6 332.278,410.645 340.637,426.318 342.727,429.453 "></polygon>
                                    ...
                                    <path style="fill:#40596B;" d="M501.551,331.233V20.898C501.551,9.404,492.147,0,480.653,0H20.898C9.404,0,0,9.404,0,20.898v310.335
                                        H501.551z"></path>
                                    <rect x="39.706" y="35.527" style="fill:#FFFFFF;" width="421.094" height="259.135"></rect>
                                    <path style="fill:#F2F2F2;" d="M367.804,461.845H133.747c-21.943,0-39.706,17.763-39.706,39.706H407.51
                                        C407.51,479.608,389.747,461.845,367.804,461.845z"></path>
                                    <circle style="fill:#CDD6E0;" cx="250.776" cy="370.939" r="13.584"></circle>
                                    <polygon style="fill:#C3D0DB;" points="340.637,426.318 160.914,426.318 169.273,410.645 170.318,409.6 331.233,409.6 
                                        332.278,410.645 "></polygon>
                                    ...
                                    <path style="fill:#54C0EB;" d="M336.457,210.024c-47.02-47.02-124.343-47.02-171.363,0c-24.033,24.033-35.527,54.335-35.527,85.682
                                        ...
                                        c1.045,2.09,1.045,5.224,2.09,7.314c1.045,5.224,2.09,10.449,2.09,16.718h40.751C371.984,264.359,360.49,233.012,336.457,210.024z"></path>
                                    </svg>
                            </div>
                            <h2>Sự Nổi Bật</h2>
                            <ul style="font-size: 1.8em;line-height: 25px;color: #777777;width: 250px;">
                               
                                <li>Giao diện đẹp, bắt mắt, thân thiện với người dùng .</li>
                                <li>Ứng dụng công nghệ thiết kế web hiện đại nhất hiện nay.</li>
                                <li>Responsive - tương thích với nhiều các thiết bị di động khác nhau đảm bảo mọi thao tác của khách hàng diễn ra trên website luôn mượt mà</li>
                        ...
                        <div class="box" style="margin-top:100%">
                            <div class="box-icon">
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 501.708 501.708"
                                    style="enable-background:new 0 0 501.708 501.708;" xml:space="preserve">
                                    ...
                                    <path style="fill:#40596B;" d="M47.177,0.078H21.055c-11.494,0-20.898,9.404-20.898,20.898v38.661h67.918V20.976
                                        C68.075,9.482,58.671,0.078,47.177,0.078z"></path>
                                    <rect x="20.01" y="80.536" style="fill:#ACB3BA;" width="28.212" height="366.759"></rect>
                                    <rect y="59.387" style="fill:#F2F2F2;" width="67.918" height="20.898"></rect>
                                    <path style="fill:#40596B;" d="M442.149,0.078H150.622c-11.494,0-20.898,9.404-20.898,20.898v459.755
                                        ...
                                        C463.047,9.482,453.642,0.078,442.149,0.078z"></path>
                                    ...
                                    <g>
                                        ...
                                        <path style="fill:#334A5E;" d="M341.838,24.111h-90.906c-4.18,0-6.269,3.135-6.269,6.269s3.135,6.269,6.269,6.269h90.906
                                            c4.18,0,6.269-3.135,6.269-6.269S346.018,24.111,341.838,24.111z"></path>
                                        <path style="fill:#334A5E;" d="M227.944,24.111h-17.763c-4.18,0-6.269,3.135-6.269,6.269s3.135,6.269,6.269,6.269h17.763
                                            c4.18,0,6.269-3.135,6.269-6.269S231.079,24.111,227.944,24.111z"></path>
                                    </g>
                                    ...
                                    <g>
                                        <path style="fill:#F2F2F2;" d="M255.112,141.14v37.616c0,22.988-18.808,40.751-40.751,40.751s-40.751-17.763-40.751-40.751
                                            c0,13.584-6.269,25.078-16.718,32.392V141.14H255.112z"></path>
                                        <path style="fill:#F2F2F2;" d="M337.659,141.14h-81.502v37.616c0,22.988,18.808,40.751,40.751,40.751l0,0
                                            c21.943,0,40.751-17.763,40.751-40.751c0,21.943,18.808,40.751,40.751,40.751c22.988,0,40.751-18.808,40.751-40.751V141.14H337.659
                                            L337.659,141.14z"></path>
                                        <path style="fill:#F2F2F2;"
                                            d="M435.879,141.14v70.008c-10.449-7.314-16.718-19.853-16.718-33.437V141.14H435.879z">
                                        </path>
                                    </g>
                                    ...
                                    <path style="fill:#54C0EB;" d="M419.161,130.691v37.616c0,22.988,18.808,40.751,40.751,40.751c22.988,0,40.751-18.808,40.751-40.751
                                        v-37.616H419.161z"></path>
                                    <polygon style="fill:#84DBFF;"
                                        points="213.316,62.772 156.891,62.772 91.063,130.691 173.61,130.691 "></polygon>
                                    <polygon style="fill:#FF7058;"
                                        points="268.696,62.772 213.316,62.772 173.61,130.691 255.112,130.691 "></polygon>
                                    <polygon style="fill:#84DBFF;"
                                        points="324.075,62.772 268.696,62.772 255.112,130.691 337.659,130.691 "></polygon>
                                    <polygon style="fill:#FF7058;"
                                        points="380.5,62.772 324.075,62.772 337.659,130.691 419.161,130.691 "></polygon>
                                    <polygon style="fill:#84DBFF;"
                                        points="435.879,62.772 380.5,62.772 419.161,130.691 501.708,130.691 "></polygon>
                                </svg>
                            </div>
                            <h2 style="width:320px;">Chuyên gia tư vấn - Hotline:</h2>
                            <p>admin@gmail.com</p>
                            <p style="color:black">SDT: 0965720364</p>
                        </div>
                    </div>
                </div>
            </section>
