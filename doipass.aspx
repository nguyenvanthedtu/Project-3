<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="doipass.aspx.cs" Inherits="CDIO.doipass" %>
...
<head runat="server">
 ...
 <style>
    ...
    font-size: 16px;
    text-align: left;
    transform: translate(102px, 32px);
}
    </style>
    ...
    <div class="container-user" style="padding-bottom:40px">
        <div class="grid wide">
            <div class="row">
                <div class="col l-2 m-3 c-3">
                        <div class="list-left" style="margin-top:-60px">
                ...
                <div class="col l-10 m-9 c-9">
                        <div class="list-right" style="margin:-70px 0 90px 0 ;text-align: center;">
                            <h1 style="font-size:20px"  class="list-right__title">
                                Quản lý hồ sơ
                            </h1>
                            <h1 class="list-right__title" style="font-weight:normal;text-align: center;margin-bottom: 30px;">
                                ...
                                <div class="" style="margin-left: 180px;">
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="mkcu" runat="server" type="password" CssClass="input-login" required></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <asp:TextBox ID="mkmoi" runat="server" type="password" CssClass="input-login" required></asp:TextBox>
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Tối thiểu tám ký tự, ít nhất một chữ cái và một số" Font-Size="Larger" Font-Italic="True" Display="Dynamic" ControlToValidate="mkmoi" ForeColor="Red" ValidationExpression="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$"></asp:RegularExpressionValidator>   
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                 <asp:TextBox ID="xnmk" runat="server" type="password" CssClass="input-login" required></asp:TextBox>
                                                 <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Mật khẩu không trùng khớp" Font-Italic="True" Font-Size="Larger" Display="Dynamic" ControlToValidate="mkmoi" ControlToCompare="xnmk" ForeColor="Red"></asp:CompareValidator>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td>
                                      <asp:Button ID="btnsavemk" runat="server" Text="LƯU" CssClass="sub-user" Style="margin-top:20px;transform:translateX(10%);height:50px; border-radius:20px;padding:10px 40px;height:40px;font-size:15px;background-color:#dd3333;border:none;" OnClick="btnsavemk_Click" Width="151px"/>
